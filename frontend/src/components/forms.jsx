...
export const FormUpdateLink = React.memo(function FormUpdateLink({ element, display, linkId, profileId }) {
  ...
  return (
    <>
      ...
      <dialog className="upload_photo" ref={dialogRef}>
        ...
        <input type="file" name="profile_photo" id={`${baseId}-profile_photo`} onChange={handleFileChange} />
